---
title: "Anatomy of the proton.swaps Exploit: ~2.1B XPR Drained, 87% Recovered, Pools Made Whole, and the Bugs Fixed for Good"
date: "2026-09-16"
excerpt: "On 12 September 2026 an attacker drained ~2.1 billion XPR from proton.swaps through a one-line accounting bug. Three days later every pool was restored to the last unit. Here is the full on-chain breakdown — how it worked, where the money went, the minute-by-minute recovery by the block producers, the exact multisigs and token amounts, the restoration, and the permanent fixes shipped so it can't happen the same way twice."
tags: ["Security", "Incident Report", "XPR Network", "DeFi", "Forensics"]
coverImage: "/images/blog/proton-swaps-heist/cover.png"
---

*Updated 16 September 2026: the restoration has executed — every token proton.swaps owes is backed to the
last unit. Full timeline, recovery multisigs and final reconciliation below.*
...
governance-controlled treasury. On 14 September the XPR Consortium approved the grant to cover what had
escaped, and on 15 September at 17:46 UTC — three days and 26 minutes after the drain — **every pool was
restored to exactly what the contract's ledger says it owes.**
...
- The **XPR Consortium granted 290,793,873.4965 XPR** to cover what escaped, and on 15 September the pools
  were **restored in a single transaction to the exact figures the contract's own ledger says it owes** —
  20 of 20 tokens at zero difference. Liquidity providers lose nothing; the pools reopen when the pause is
  lifted.
...
fifteen tokens, after a 10 XPR test a minute earlier. Final reconciliation against the contract's own ledger:

| Token | Owed (pools + deposits) | Held after restore | Difference |
|---|---|---|---|
...
| XMD | 571,767.317953 | 571,767.317953 | 0 |
...
fraction of an XMD that the pools weren't owed. The pools reopen when Metallicus lifts the pause.
